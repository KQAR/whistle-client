...
# v1.6.1
1. feat: update whistle to v2.10.1
...
2. feat: optimize the dropdown menu
...
# v1.1.2
1. feat: update whistle to v2.9.68

# v1.1.1
1. feat: Modify Mac client desktop icon
2. feat: update whistle to v2.9.67

# v1.1.0
1. feat: update Dock and system tray icons (thanks to @22dm for suggestions and assets: https://github.com/avwo/whistle-client/issues/26)
2. feat: update whistle to v2.9.66

# v1.0.9
1. feat: update whistle to v2.9.65

# v1.0.8
1. feat: update whistle to v2.9.64

# v1.0.7
1. feat: update whistle to v2.9.63

# v1.0.6
1. feat: update whistle to v2.9.61

# v1.0.5
# v1.0.4
1. feat: update whistle to v2.9.60

# v1.0.3
1. feat: update Whistle to [v2.9.59](https://github.com/avwo/whistle/blob/master/CHANGELOG.md#v2959)
2. feat: update Electron version
3. feat: support direct preview in `Inspectors/Response/Preview`

# v1.0.2
1. feat: update Whistle to [v2.9.57](https://github.com/avwo/whistle/blob/master/CHANGELOG.md#v2957)
2. feat: Display system proxy status in the title bar

# v1.0.1
1. feat: update Whistle to [v2.9.56](https://github.com/avwo/whistle/blob/master/CHANGELOG.md#v2956)
2. fix: issue where setting system proxy might fail immediately after boot

# v1.0.0
1. feat: bundle Whistle v2.9.55
